...
try {
    match ($action) {
        'register' => handleUserRegister($pdo),
        'login'    => handleUserLogin($pdo),
        'logout'   => handleUserLogout(),
        'check'    => handleUserCheck($pdo),
...
function handleUserRegister(PDO $pdo): void {
...
function handleUserLogin(PDO $pdo): void {
...
function handleUserCheck(PDO $pdo): void {
